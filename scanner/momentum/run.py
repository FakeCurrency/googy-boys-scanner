    ...
    payload = {
        ...
        "model": {
            ...
            "stop": {"swing_bars": config.BT_SWING_BARS, "atr_pad": config.BT_ATR_PAD,
                     ...
                     "second_column": "worst print of the bar (the 5.0 backtest's fill)"},
        ...
        # the same trades under the 5.0 backtest's worst-print stop fill
        # (2026-09-24, like-for-like R): `summary` is the house rule
        "summary_worst_print": bt.summarise(trades, config.BT_NOTIONAL, fill="worst_print"),
