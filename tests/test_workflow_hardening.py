...
# (The stop_watcher.yml verdict suite lived here — the curl-exit-code guard,
#  the 401/500/502 fatal cases, the 503 green branch, the 4-tick loop and the
#  piggyback ticks. stop_watcher.yml and /api/tick were removed 2026-09-21 with
#  the manual journal they served; nothing is left to pin.)
