...
tests/ + phasemap/tests/ + test/*.test.js   1245 pytest (58 files) + 642 JS (16 suites) — EVERY push (test.yml)
...
python -m pytest -q                      # full gate (1245 tests / 58 files, 2026-07-29)
node test/risk_manager.test.js           # + 15 more JS suites, 642 total; see test.yml
